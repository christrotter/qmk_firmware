...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        _______,LGUI(KC_1),_______,KC_TAB_L,_______,_______,     KC_NO, _______, SUP_ALT_TAB,                                      KC_MACSHOT,KC_TAB_L,KC_TAB_R,MAGIPLAY, LGUI(KC_9), KC_EQUAL,     KC_NO, LGUI(KC_TILD), _______,
    ...
    [_NAV] = LAYOUT(
        _______, _______, _______, _______, _______, _______,           _______,_______,_______,_______,_______,                    _______, _______, _______, _______, _______, _______,                       _______,_______,_______,_______,_______,
        EE_CLR,  QK_BOOT, _______, _______, _______, _______,           _______,_______,_______,                                    _______, _______, KC_SFTARROW_U, _______, QK_BOOT, EE_CLR,                 _______,_______,_______,
...
//     [_QWERTY]   = LEDMAP(
   ...
   [_QWERTY]   = LEDMAP(
    ...
    CYAN, CYAN, ___n___, RED, ___n___, ___n___,                                             ORANGE, RED, GREEN, PINK, CYAN,    CYAN,
