...
#define ENCODER_DEFAULT_POS 3
    ...
    #define RGB_INDICATOR_L1_START 108
    #define RGB_INDICATOR_L1_END 109
    #define RGB_INDICATOR_L2_START 110
    #define RGB_INDICATOR_L2_END 112
    ...
    #define RGB_INDICATOR_R1_START 221
    #define RGB_INDICATOR_R1_END 222
    #define RGB_INDICATOR_R2_START 223
    #define RGB_INDICATOR_R2_END 225
