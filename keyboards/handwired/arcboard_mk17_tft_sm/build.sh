#!/bin/bash
KB_PATH=handwired/arcboard_mk17_tft_sm
HOME_DIR=/Users/christrotter/git/printing/qmk_firmware
KB_DIR=$HOME_DIR/keyboards/$KB_PATH
USER_DIR=$HOME_DIR/users/christrotter

BUILD_CORES=12
KEYMAP='default'
KEYBOARD='handwired/arcboard_mk17_tft_sm'
...
if [ "$1" == "build" ];then
    ...
    qmk compile -c -kb $KEYBOARD -km $KEYMAP -j $BUILD_CORES
elif [ "$1" == "left" ];then
